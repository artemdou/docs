...
description: "This guide outlines the basics of using American Express card via Checkout and gives you instructions needed for a fluent implementation."
---
...
### Functionality Table American Express
|  |  |
| --- | --- |
| Payment type | Card |
| Subscriptions | ✅ |
...
1. When your consumer chooses American Express as a payment method in the checkout, they will be prompted to enter their:
